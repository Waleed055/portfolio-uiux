...
const ContactBottom = () => {
    const socials = [
        ...
        { icon: <span style={{ fontSize: '14px' }}>up</span>, label: 'upwork' },
        { icon: <span style={{ fontSize: '14px' }}>fi</span>, label: 'fiverr' }
    ];
        ...
        <div className="contact-bottom-container">
            <div className="social-icons-row">
                {socials.map((social, index) => (
                    <a key={index} href="https://example.com" target="_blank" rel="noopener noreferrer" className="social-icon-circle" aria-label={social.label}>
